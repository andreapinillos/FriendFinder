...
*Friend Finder* is deployed to Heroku. Please check it out [here](https://powerful-inlet-59066.herokuapp.com/).

## Installation

To install the application follow the instructions below:

	git clone https://github.com/andreapinillos/FriendFinder.git
	cd friendFinder
	npm install
